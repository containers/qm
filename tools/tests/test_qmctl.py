...
class TestQmError:
    ...
    def test_config_not_found_error(self):
        ...
        assert error.exit_code == 2  # errno.ENOENT
...
class TestIntegration:
    ...
    def test_exec_in_container_empty_output(
        ...
        # Verify podman exec no raising an exception
...
class TestMainFunction:
    ...
    def test_main_function_calls(self, mock_run_command, mock_argv):
        ...
        with patch('qmctl.qmctl.argcomplete', create=True):
            main()
