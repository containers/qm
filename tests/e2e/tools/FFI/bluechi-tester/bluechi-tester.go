...
const (
	...
	InternalAgentSignalJobDone = "org.eclipse.bluechi.internal.Agent.JobDone"
	InternalAgentSignalUnitNew = "org.eclipse.bluechi.internal.Agent.UnitNew"
	// ...
)
	...
	rootCmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		if signalName == "jobdone" {
			...
			for i := 0; i < numberSignals; i++ {
				err = conn.Emit(InternalAgentObject, InternalAgentSignalJobDone, 10, "fake-state")
				if err != nil {
