...
cleanup() {
    ...
    if [ $exit_code -ne 0 ]; then
        info_message "Script failed, performing cleanup..."
    else
        info_message "Script completed, performing cleanup..."
    fi
    ...
    # If you want to clean up the container as well, uncomment the following lines:
    # info_message "Cleaning up test container..."
