...
#### Step 2: Add Required Capabilities to QM

Create a QM drop-in file to add the necessary capability:

**Create:** `/etc/containers/systemd/qm.container.d/AddCAPA.conf`
