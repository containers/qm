...
13. [Change configuration in QM](#change-configuration-in-qm)
...
## Changing QM Configuration in an Immutable OS (OSTree)
...
To check the existing memory limit for QM, run:  
...
#### Checking the Updated Memory Limit
...
To ensure the 2G limit is enforced, check the value of `MemoryHigh` by running:
